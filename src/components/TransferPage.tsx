...
export default function TransferPage({ onSelect }: { onSelect: (d: Dest) => void }) {
  return (
    <div className="flex flex-col  h-full bg-white  my-10">
      {/* Header */}
...
<div className="px-5 pb-5">
  {/* تغییر کلاس به flex-col و اضافه کردن items-center برای قرارگیری عمودی در وسط */}
  <div className="flex flex-col items-start justify-center gap-3">
    ...
    {/* بخش متون (با اضافه شدن text-center برای تراز وسط متن‌ها) */}
    <div className="text-center">
      ...
      {/* FAB */}
      <div className="fixed bottom-[8rem] left-1/2 -translate-x-1/2 bg-primary text-white px-7 py-3 rounded-full flex items-center gap-2  cursor-pointer font-medium text-[15px] z-40"
